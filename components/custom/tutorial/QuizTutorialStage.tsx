...
interface QuizTutorialStageProps {
  onContinue: () => void
  isLastStage: boolean
  isTransitioning: boolean
}

export default function QuizTutorialStage({
  onContinue,
  isLastStage,
  isTransitioning
}: QuizTutorialStageProps) {
      ...
      <View style={styles.imageContainer}>
        <View style={[styles.imagePlaceholder, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          <Image
            ...
            source={require('@/assets/images/tutorial/quiz-tutorial.png')}
          />
        </View>
      </View>
